 ...
 *  IBMData Service JavaScript SDK v1.0.0.20141023-1310
 *
 */

 
// Generated by IBMData SDK v0.7.0-beta4 - template: 'combined' 
...
var IBMDataHybrid = _.extend({}, _IBMData, {
    ...
    _init: function () {
      ...
      this._dataHybrid.exec("initializeService", []).done(function (status) {
        self.service = new IBMDataService(new CordovaRequest(self._dataHybrid, self._queryHybrid));
        if (!_.isObject(self.service)) {
          defer.reject("Failed to create an IBM Data Service Object");
        }
        defer.resolve(self.service);
      }, function (err) {
        defer.reject("Failed ");
      });
      return defer.promise;
