cordova.define("com.ibm.mobile.cordova.ibmbluemix.hybrid", function(require, exports, module) { /*!
 *  Licensed Materials - Property of IBM
 *  5725-I43 (C) Copyright IBM Corp. 2011, 2014. All Rights Reserved.
 *  US Government Users Restricted Rights - Use, duplication or
 *  disclosure restricted by GSA ADP Schedule Contract with IBM Corp.
 *
 *  IBM Mobile Cloud Services JavaScript SDK, v1.0.0.20141023-1310
 *
 */
...
// Generated by IBMBluemix SDK v0.7.0-beta4 - template: 'combined' 
...
var bundleFactory = function(exec) {/**
...
define('ibm/mobile/utils/IBMHybrid', ['require', 'exports', 'module', '../lib/IBMUnderscore', '../lib/IBMQ', './IBMLogger', 'cordova/exec'], function (require, exports, module, _, Q, ibmLogger) {
  var __umodule__ = (function (require, exports, module, _, Q, ibmLogger) {
  

var logger = ibmLogger.getLogger();
  var WL = WL, cordova = cordova, exec;
  if (WL) {
    if (cordova) {
      exec = cordova.exec;
    }
...
var CLIENT_PLATFORM_TYPE = "HYBRID";
  ...
  if (!window.IBMBluemix) {
    window.IBMBluemix = IBMBluemixHybrid;
  }
...
if (__isAMD) {
  return define(['cordova/exec'], bundleFactory);
} else {
    if (__isNode) {
        return module.exports = bundleFactory(require('cordova/exec'));
    } else {
        return bundleFactory((typeof exec !== 'undefined') ? exec : void 0);
    }
}
